...
Optional dependencies (install via `python3 -m pip install <packagename>`):
  ...
  * Pushover reporter: [python-pushover](https://github.com/Thibauth/python-pushover)
...
python-pushover python package installed (see DEPENDENCIES). Then edit your config
